...
<body>
<form method="post" action="lihatcari2.php">
 <nav>
    <div class="nav-wrapper">
      <a href="halaman_admin1.php" class="brand-logo">DATA GURU</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
       
        <!-- <li class="input-field"><input type="text" name="cari" required></li> -->
       <li class="nav-item"><a class="nav-link" href="kembaliguru2.php">kembali</a></li>
