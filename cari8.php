    ...
    <tbody>
        ...
        while($data = mysqli_fetch_array($result)) {
           ...
           echo "<td>".$data['tglkembaliguru']."</td>";
            ...
            echo "<td>";
            echo "<a href='edit_adminkembaliguru.php?kodekembaliguru=".$data['kodekembaliguru']."'>Edit</a> | ";
            echo "<a href='hapuskembaliguru.php?kodekembaliguru=".$data['kodekembaliguru']."'>Hapus</a>";
            echo "</td>";
