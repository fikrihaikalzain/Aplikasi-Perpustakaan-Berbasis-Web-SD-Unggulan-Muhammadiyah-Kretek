...
echo "<br>";
$result =mysqli_query($koneksi, "SELECT * FROM pengembalian WHERE kodekembali LIKE '%$key%' OR idpeminjam LIKE '%$key%' OR kodebuku  LIKE '%$key%' OR tglpengembalian LIKE '%$key%'");
...
<form method="post" action="cari5.php">
 <nav>
    <div class="nav-wrapper">
      <a href="halaman_admin.php" class="brand-logo">DATA PENGEMBALIAN BUKU SISWA</a>
    ...
    <tbody>
        ...
        while($data = mysqli_fetch_array($result)) {
           ...
           echo "<td>".$data['tglpengembalian']."</td>";
            ...
            echo "<td>";
            echo "<a href='edit_adminkembali.php?kodekembali=".$data['kodekembali']."'>Edit</a> | ";
            echo "<a href='hapuskembali.php?kodekembali=".$data['kodekembali']."'>Hapus</a>";
            echo "</td>";
