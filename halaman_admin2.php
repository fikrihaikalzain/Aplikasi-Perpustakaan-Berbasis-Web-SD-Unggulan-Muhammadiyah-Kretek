 ...
 <nav>
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="halaman_admin2.php">Data Guru</a></li>&emsp;
    ...
    <tbody>
        <?php
        $sql = "SELECT * FROM peminjamguru where idpeminjamguru";
        ...
        while($data = mysqli_fetch_array($query)){
            ...
            echo "<td><a href='edit_adminguru.php?idpeminjamguru=$data[idpeminjamguru]'>Edit</a>  | <a href='hapusguru.php?idpeminjamguru=$data[idpeminjamguru]' onclick='if(!confirm(`Apakah anda yakin hapus ini?`)){return false}'>Delete</a></td></tr>";   
